...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        musicList.add(new Music(getRawUri(R.raw.untuk_perempuan_payung_teduh), "Payung Teduh - Untuk Perempuan yang Seddang Dalam Pelukan"));
        musicList.add(new Music(getRawUri(R.raw.kangen), "Dewa 19 - Kangen"));
